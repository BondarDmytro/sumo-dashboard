...
const RIKISHI = [
  ...
  [5, 'Atamifuji',     'S1e', 'Секіваке',     9, 'утримав ранг'],  // sekiwake_official_v1: офіц. банзуке 29.06
  [6, 'Kotoshoho',     'S1w', 'Секіваке',     8, 'утримав ранг'],
  [7, 'Wakatakakage',  'S2e', 'Секіваке',    14, 'чемпіон Натсу (12-3), озекі-ран'],
