    ...
    <div style={{maxWidth:900,margin:'0 auto',padding:'2rem 1rem',fontFamily:'monospace'}}>
      ...
      <div style={{borderTop:'1px solid var(--border)',paddingTop:'2rem'}}>
        ...
        {reviewsLoading ? (
          ...
          <div style={{textAlign:'center',color:'var(--mid)',fontSize:'0.8rem',padding:'2rem',background:'var(--bg2)',borderRadius:6}}>Відгуків ще немає</div>
        ) : (
          <>
            ...
            {reviews.length > 5 && (
              <button onClick={() => setShowAllReviews(v => !v)} style={{marginTop:12,width:'100%',padding:'0.6rem',background:'var(--bg2)',border:'1px solid var(--border)',color:'var(--mid)',borderRadius:4,fontFamily:'monospace',fontSize:'0.65rem',cursor:'pointer'}}>
