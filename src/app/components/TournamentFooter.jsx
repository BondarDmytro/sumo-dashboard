    ...
    <>
      ...
      <div className="anim-6" style={{marginTop:'2.5rem',paddingTop:'1.5rem',borderTop:'1px solid var(--border)',fontSize:'0.72rem',color:'var(--mid)',lineHeight:1.7}}>
        {lang === 'ja' ? (
          ...
          <><b style={{color:'var(--ink)'}}>Data:</b> sumo-api.com · updates every 60 seconds · <b style={{color:'var(--ink)'}}>Methodology:</b> logistic model trained on 36 basho (2020–2026): record, gap to leader, rank, 5-day form. Day-10 top-1 accuracy ≈ 50–60% (holdout). Fusen (✦) — win by opponent withdrawal. Not a bet.</>
